...
public class Game2048 extends Game {
    ...
    // setCellColoredNumber(0, 1, gameField[0][1]);
    // setCellColoredNumber(0, 2, gameField[0][2]);
    // setCellColoredNumber(0, 3, gameField[0][3]);
    // setCellColoredNumber(1, 0, gameField[1][0]);
    // setCellColoredNumber(1, 1, gameField[1][1]);
    // setCellColoredNumber(1, 2, gameField[1][2]);
    // setCellColoredNumber(1, 3, gameField[1][3]);
    // setCellColoredNumber(2, 0, gameField[2][0]);
    // setCellColoredNumber(2, 1, gameField[2][1]);
    // setCellColoredNumber(2, 2, gameField[2][2]);
    // setCellColoredNumber(2, 3, gameField[2][3]);
    // setCellColoredNumber(3, 0, gameField[3][0]);
    // setCellColoredNumber(3, 1, gameField[3][1]);
    // setCellColoredNumber(3, 2, gameField[3][2]);
